...
class WorkspacePolicy
{
    ...
    public function view(User $User, Model $Model): bool
    {
        ...
        // if is member and not banned
        if (DiscreteApiHelper::in_organization($User, $Model->organization) && DiscreteApiHelper::organization_member_role($User, $Model->organization) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public function update(User $User, Model $Model): bool
    {
        ...
        // if is member and admin or owner
        if (DiscreteApiHelper::in_organization($User, $Model->organization) && DiscreteApiHelper::organization_member_role($User, $Model->organization) >= 9) {
            return true;
        }
        return false;
    }
